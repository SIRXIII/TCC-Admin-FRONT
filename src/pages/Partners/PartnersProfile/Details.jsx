...
const Details = ({ partner }) => {
  ...
  const verification = {
    items: [
      ...
      { label: "Tax ID", value: partner.tax_id || "Not Available" },
      { label: "Owner Name", value: partner.name || "Not Available" },
      {
        label: "ID Proof",
        value:
          partner.documents?.owner_id_card?.length > 0
            ? "Driver’s License - Verified"
            : "Driver’s License - Not Verified",
      },
      { label: "Inspection Status", value: partner.status === "active" ? "Completed" : "Not Completed" },
    ],
  };
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex flex-col gap-6 flex-1">
        ...
        <div className="bg-white shadow rounded-lg p-4 md:p-6">
          <h3 className="text-lg fw6 mb-4">Store Timing</h3>
          <PartnerInfo items={availableDays} partnerId={partner.id} />
        </div>

        <div className="bg-white shadow rounded-lg p-4 md:p-6">
          <h3 className="text-lg fw6 mb-4">Support & Rating</h3>
          <PartnerInfo items={supportRating.items} partnerId={partner.id} />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 flex-1">
        ...
        <div className="bg-white shadow rounded-lg p-4 md:p-6">
          <h3 className="text-lg fw6 mb-4">Verification & Compliance</h3>
          <PartnerInfo items={verification.items} partnerId={partner.id} />
        </div>
      </div>
    </div>
